...
const Projects = () => {
    return (
        <div id='projects' className="md:my-20 my-8">
            <h1 className="md:text-4xl text-3xl text-center font-bold font-primary mb-7 md:mb-10 text-[#2d4a8a]">Projects</h1>
            {/* card container */}
            <div className='grid  md:grid-cols-2 gap-6'>
                {/* project 1 */}
                <div className="card rounded-sm  card-compact bg-base-100  shadow-xl">
                    <figure>
                        <img className='md:h-[280px] h-[200px] w-full'
                            src={project1}
                            alt="" />
                    </figure>

                    <div className="card-body">
                        <h2 className="card-title font-primary text-xl md:text-2xl">Project : Hotel Luxury</h2>
                        <h2 className=" font-primary text-lg md:text-xl"><span className='font-bold'>Live Link :</span> <a href="https:hotel-luxury-6656d.web.app" className='text-sky-600 underline'>https:hotel-luxury-6656d.web.app</a> </h2>

                        <h2 className=" font-primary text-lg md:text-xl"><span className='font-bold'>Github Code :</span> <a href="https://github.com/Boniaminshawon/Hotel_Luxury_Client" className='text-sky-600 underline'>Client Side  </a>   <a href="" className='text-sky-600 underline ml-6'> Server Side</a> </h2>

                        <p className='md:text-lg text-base font-secondary'><span className='font-bold '>Overview:</span>This project involves developing a hotel booking website featuring integrated map locations, user reviews, and a price range filter for rooms. Users can register and log in for a personalized experience and access private routes requiring authentication. The website is fully responsive across all devices, ensuring a seamless user experience.
                        ...
                        <div className='text-base  font-secondary'><span className='font-bold font-primary md:text-xl text-lg'>Key Features:</span> <br />
                        ...
                        <div className=' md:text-lg text-base font-secondary'>
                            <span className='font-bold font-primary text-lg md:text-xl '>Technology: </span>
                ...
                <div className="card  card-compact bg-base-100 rounded-sm shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="card-title font-primary  text-xl md:text-2xl">Project : AItech</h2>
                        <h2 className=" font-primary text-lg md:text-xl"><span className='font-bold'>Live Link :</span> <a href="https:ai-tech-ae69b.web.app" className='text-sky-600 underline'>https:ai-tech-ae69b.web.app</a> </h2>

                        <h2 className=" font-primary text-lg md:text-xl"><span className='font-bold'>Github Code :</span> <a href="https://github.com/Boniaminshawon/AItech-client" className='text-sky-600 underline'>Client Side  </a>   <a href="" className='text-sky-600 underline ml-6'> Server Side</a> </h2>
                        ...
                        <div className='text-base font-secondary'><span className='font-bold font-primary text-lg md:text-xl'>Key Features:</span> <br />
           ...
           <div className='md:w-2/3'>
                ...
                <div className="card rounded-sm  card-compact bg-base-100  shadow-xl">
                    <figure>
                        <img className='md:h-[340px] h-[200px]  w-full'
                            src={project3}
                            alt="" />
                    </figure>

                    <div className="card-body">
                        <h2 className="card-title font-primary text-xl md:text-2xl">Project : Art and Crafts</h2>
                        <h2 className=" font-primary text-lg md:text-xl"><span className='font-bold'>Live Link :</span> <a href="https:https://handi-crafts.web.app" className='text-sky-600 underline'>https:https://handi-crafts.web.app</a> </h2>

                        <h2 className=" font-primary text-lg md:text-xl"><span className='font-bold'>Github Code :</span> <a href="https://github.com/Boniaminshawon/Handi-Crafts-Client" className='text-sky-600 underline'>Client Side  </a>   <a href="" className='text-sky-600 underline ml-6'> Server Side</a> </h2>
