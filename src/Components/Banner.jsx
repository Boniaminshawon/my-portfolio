...
const Banner = () => {
    ...
    return (
        ...
        className='py-16 font-secondary bg-red-40'>
            ...
            <div className='flex justify-between'>
                <div className='pl-20  flex-1 flex flex-col justify-center'>
                    ...
                    <a href={resume} download={'resume'} className='btn text-lg font-secondary mt-7 w-1/3 border border-black '>Download Resume</a>
